...
>
> + 提交的内容：将**4个assignment的代码**和**实验报告**放到**压缩包**中，命名为“**lab4-学号-姓名**”，并交到课程并交到课程邮箱 os_sysu_lab@163.com
>
...
void print_something() {
    printf("SYSU 2024 Spring Operating System Course.\n");
}
```
...
+ **链接**。将多个可重定位文件链接生成可执行文件，Linux下一般以`.out`为后缀，Windows下则以`.exe`为后缀。
